...
export declare type tonNode_BlockId = tonNode_blockId;
export declare type tonNode_BlockIdExt = tonNode_blockIdExt;
export declare type tonNode_ZeroStateIdExt = tonNode_zeroStateIdExt;
export declare type adnl_Message = adnl_message_query | adnl_message_answer;
export declare type liteServer_Error = liteServer_error;
export declare type liteServer_AccountId = liteServer_accountId;
export declare type liteServer_MasterchainInfo = liteServer_masterchainInfo;
export declare type liteServer_MasterchainInfoExt = liteServer_masterchainInfoExt;
export declare type liteServer_CurrentTime = liteServer_currentTime;
export declare type liteServer_Version = liteServer_version;
export declare type liteServer_BlockData = liteServer_blockData;
export declare type liteServer_BlockState = liteServer_blockState;
export declare type liteServer_BlockHeader = liteServer_blockHeader;
export declare type liteServer_SendMsgStatus = liteServer_sendMsgStatus;
export declare type liteServer_AccountState = liteServer_accountState;
export declare type liteServer_RunMethodResult = liteServer_runMethodResult;
export declare type liteServer_ShardInfo = liteServer_shardInfo;
export declare type liteServer_AllShardsInfo = liteServer_allShardsInfo;
export declare type liteServer_TransactionInfo = liteServer_transactionInfo;
export declare type liteServer_TransactionList = liteServer_transactionList;
export declare type liteServer_TransactionId = liteServer_transactionId;
export declare type liteServer_TransactionId3 = liteServer_transactionId3;
export declare type liteServer_BlockTransactions = liteServer_blockTransactions;
export declare type liteServer_Signature = liteServer_signature;
export declare type liteServer_SignatureSet = liteServer_signatureSet;
export declare type liteServer_BlockLink = liteServer_blockLinkBack | liteServer_blockLinkForward;
export declare type liteServer_PartialBlockProof = liteServer_partialBlockProof;
export declare type liteServer_ConfigInfo = liteServer_configInfo;
export declare type liteServer_ValidatorStats = liteServer_validatorStats;
export declare type liteServer_debug_Verbosity = liteServer_debug_verbosity;
